...
/*
 * Requerimientos de midificación para ajustar el programa de escritura de archivos binarios:
  * -- Modificación de la estructura de los registros
  * -- Añadir datos a cada registro, además crear espacios adicionales para poder
  * -- añadir más registros al archivo binario.
  * -- -- Dirección Lógica (Esta de preferencia debe ser auto incremental (el usuario no
  *       deberá manipularla o estar conciente enteramente de su existencia).
  * -- -- Clave de identificación (Código Postal)
  * -- -- Nombre de ciudad donde se localiza la sucursal
  * -- -- Tabla o matriz de adyacencia
  * */
